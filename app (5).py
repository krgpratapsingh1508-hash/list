...
DEFAULT_CREDENTIALS = {
    "admin": {"password": "admin123", "role": "admin", "label": "👑 Super Admin (P1–P5 Full Control)"}
}
...
if st.session_state.user_role is None:
    ...
    with login_col:
        ...
        st.caption("Default admin login → **admin / admin123** (पहली बार login करने के बाद P5 → Admin Panel से password बदल लें)")
    st.stop()
...
# ==========================================================
# 🛠️ P5 — ADMIN PANEL  (Admin only)
# ==========================================================
elif choice == "P5 — Admin Panel":
    st.header("🛠️ P5 — Admin Panel")
